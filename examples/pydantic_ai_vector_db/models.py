...
class SearchQuery(BaseModel):
    ...
    threshold: float = Field(default=0.0, description="Minimum similarity threshold", ge=0.0, le=1.0)
...
class ChatQuery(BaseModel):
    ...
    context_limit: int = Field(default=3, description="Max number of context documents to use")
